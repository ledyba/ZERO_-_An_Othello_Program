...
public class MainFrame
  ...
  public static final int p[] = new int[89]; //こっちはデータ
  public static final Image WinIcon = Toolkit.getDefaultToolkit().createImage(
      othello.MainFrame.class.getResource("icon.png"));

  public static final ImageIcon white_img = new ImageIcon(
      Toolkit.getDefaultToolkit().createImage(
          othello.MainFrame.class.getResource("white.png")));
  public static final ImageIcon black_img = new ImageIcon(
      Toolkit.getDefaultToolkit().createImage(
          othello.MainFrame.class.getResource("black.png")));
  public static final ImageIcon null_img = new ImageIcon(
      Toolkit.getDefaultToolkit().createImage(
          othello.MainFrame.class.getResource("null.png")));
  public static boolean man_select_lock = true; //入力にロックがかかっているか？
  public static boolean game_start = false; //ゲーム中か？
  public static boolean edit_mode = false;
  public static boolean isUsedEditMode = false;
  ...
  public final static String[] kifu_table = { //ゲーム終了時の棋譜表示用．
      "", "", "", "", "", "", "", "", "", "",
  ...
  static String kifu = ""; //棋譜記録用
  static String kifuFileName = "record.txt";
  static PrintStream pr;
  static Calendar cal;
  static DateFormat dfm = new SimpleDateFormat("yyyy/MM/dd/HH:mm:ss"); //フォーマット
  /*
    p[]における数値と駒の関係
    1 先手(黒)
   -1　後手(白)
  ...
  JCheckBoxMenuItem jCheckBoxMenuItem1 = new JCheckBoxMenuItem(); //フレームのビルド
  ...
  private void jbInit() throws Exception {
    ...
    this.setIconImage(WinIcon); //アイコンの設定
    ...
    program_name_label.setBorder(null);
    ...
    program_name_panel.setLayout(gridBagLayout2);
    ...
    for (int i = 1; i <= 8; i++) { //横軸のアルファベット
      bord_panel.add(new JLabel(Alphabet[i])
    ...
    for (int i = 1; i <= 8; i++) { //縦軸の数字表示
      bord_panel.add(new JLabel(String.valueOf(i))
    ...
    for (int i = 0; i < 8; i++) {
      for (int j = 0; j < 8; j++) {
        ...
        bord_panel.add(piece[ (10 * (i + 1)) + (j + 1)]
                       , new GridBagConstraints(i + 1, j + 1, 1, 1, 0.0, 0.0
                                                , GridBagConstraints.CENTER,
                                                GridBagConstraints.NONE
    ...
    jMenu2.add(jMenu1);
    program_name_panel.add(program_name_label,
                           new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
                                                  , GridBagConstraints.CENTER,
                                                  GridBagConstraints.NONE,
                                                  new Insets(4, 1, 1, 1), 1, 1));
  }
  ...
  public static void game_control(int kifu) {
    ...
    if (64 <= white_piece + black_piece) {
      ...
      if (turn == 1) { //黒(先手)
        ...
        statusBar.setText("TURN:" + player_names[0] + "(Black)  NOW BLACK：" +
                          black_piece + " WHITE：" + white_piece);
      }
      else if (turn == -1) { //白(後手)
        ...
        statusBar.setText("TURN:" + player_names[1] + "(White)  NOW BLACK：" +
                          black_piece + " WHITE：" + white_piece);
      }
    }
    /*
  ...
  public static void end(int b, int w) {
    if (w > b) {
      statusBar.setText(player_names[1] + " won this game. black:" + b +
                        " white:" + w);
      System.out.println(player_names[1] + " won this game. black:" + b +
                         " white:" + w);
    }
    else if (b > w) {
      statusBar.setText(player_names[0] + " won this game. black:" + b +
                        " white:" + w);
      System.out.println(player_names[0] + " won this game. black:" + b +
                         " white:" + w);
    }
    else {
      statusBar.setText("Dwaw black:" + b + " white:" + w);
      System.out.println("Dwaw black:" + b + " white:" + w);
    }
    System.out.println("record:\n" + kifu);
    if (!isUsedEditMode) { //エディットモードの場合はファイルに書く意味が無い．
      File kifuFile = new File(kifuFileName);
      try {
        cal = Calendar.getInstance();
        if (!kifuFile.canRead()) {
          kifuFile.createNewFile(); //無い場合は作って，
          pr = new PrintStream(new FileOutputStream(kifuFile, true)); //ストリーム作成
          pr.println("yyyy/MM/dd/HH:mm:ss#black:white#record");
        }
        else {
          pr = new PrintStream(new FileOutputStream(kifuFile, true)); //ストリーム作成
        }
        pr.println(dfm.format(cal.getTime()) + "#" + b + "(" + player_names[0] +
                   "):" + w + "(" + player_names[1] + ")#" + kifu);
        pr.close();
        pr = null;
      }
      catch (Exception e) {
  ...
  void jCheckBoxMenuItem1_actionPerformed(ActionEvent e) { //edit mode
    if (game_start && !man_select_lock) {
      if (!edit_mode) {
        ...
        isUsedEditMode = true;
        kifu = "";
        System.out.println("Record was cleard.");
      }
      else {
        edit_mode = false;
      }
...
class jMenuFileExit_actionPerformed
...
class jMenuHelpAbout_actionPerformed
    implements ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece11_actionAdapter
...
class MainFrame_piece12_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece13_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece14_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece15_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece16_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece17_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece18_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece21_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece22_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece23_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece24_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece25_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece26_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece27_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece28_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece31_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece32_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece33_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece34_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece35_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece36_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece37_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece38_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece41_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece42_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece43_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece44_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece45_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece46_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece47_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece48_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece51_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece52_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece53_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece54_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece55_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece56_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece57_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece58_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece61_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece62_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece63_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece64_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece65_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece66_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece67_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece68_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece71_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece72_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece73_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece74_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece75_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece76_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece77_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece78_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece81_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece82_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece83_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece84_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece85_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece86_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece87_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
...
class MainFrame_piece88_actionAdapter
    implements java.awt.event.ActionListener {
  MainFrame adaptee;
